...
collaborative-drawing-description = Create and draw together in real-time with others.
collaborative-create-private-room = Create Private Room
collaborative-create-public-room = Create Public Room
collaborative-canvas-size = Canvas Size
collaborative-canvas-small = Small (400×300)
collaborative-canvas-medium = Medium (800×600)
collaborative-canvas-large = Large (1200×900)
collaborative-canvas-wide = Wide (1600×900)
collaborative-canvas-square = Square (800×800)
collaborative-active-public-rooms = Active Public Rooms
collaborative-user-singular = user
collaborative-user-plural = users
collaborative-last-updated = Last updated:
collaborative-no-active-rooms = No active public rooms at the moment.
collaborative-auth-message = login to create private rooms and join existing rooms.
collaborative-public-room-title = Public Drawing Room

# Canvas UI strings
collaborative-welcome-message = Welcome to the collaborative drawing room!
collaborative-connected = Connected to drawing room
collaborative-disconnected = Disconnected from drawing room
collaborative-connection-error = Connection error occurred
collaborative-system = System
collaborative-picked-color = Picked color: {$color}
collaborative-chat-placeholder = Type a message...

# Canvas tools
collaborative-tools = Tools
collaborative-brush = Brush
collaborative-eraser = Eraser
collaborative-color-picker = Color Picker
collaborative-pan = Pan
collaborative-precision-tools = Precision Tools
collaborative-pixel = Pixel
collaborative-halftone = Halftone
collaborative-show-grid = Show Grid
collaborative-size = Size
collaborative-opacity = Opacity
collaborative-colors = Colors
collaborative-layers = Layers
collaborative-background = Background
collaborative-toggle-visibility = Toggle Visibility
collaborative-add-layer = Add Layer
collaborative-delete-layer = Delete Layer
collaborative-merge-down = Merge Down
collaborative-advanced = Advanced
collaborative-blend-mode = Blend Mode
collaborative-normal = Normal
collaborative-multiply = Multiply
collaborative-screen = Screen
collaborative-overlay = Overlay
collaborative-soft-light = Soft Light
collaborative-hard-light = Hard Light
collaborative-color-dodge = Color Dodge
collaborative-color-burn = Color Burn
collaborative-actions = Actions
collaborative-clear-canvas = Clear Canvas
collaborative-save-image = Save Image
collaborative-undo = Undo
collaborative-redo = Redo
collaborative-fit-to-screen = Fit to Screen
collaborative-users = Users