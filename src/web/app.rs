...
use crate::web::handlers::collaborate::{
    collaborate_lobby, create_collaborative_session, get_auth_info, get_session_metadata, save_collaborative_session, serve_collaborative_app, websocket_collaborate_handler
};
...
impl App {
    ...
    pub async fn serve(self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        let app = Router::new()
            ...
            .route("/collaborate/:uuid", get(serve_collaborative_app).post(save_collaborative_session))
            .route("/collaborate/:uuid/meta", get(get_session_metadata))
