...
/*
  ...
  What a tool is *called* lives in `./labels`, as a message with a stable id
  like everything else this package puts on screen. It used to live here, as a
  flat table of one language's output -- which is how a Japanese painter came
  to read "Halftone" where their NEO says トーン.
*/
