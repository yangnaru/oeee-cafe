...
/**
 * Placing a window the way the painter places its own: `PANEL_MARGIN` is how
 * far from an edge they stand, and `minimumTop` is how high they may go, given
 * the element the painter was mounted into.
 *
